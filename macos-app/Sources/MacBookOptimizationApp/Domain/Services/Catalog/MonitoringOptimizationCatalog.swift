...
extension OptimizationCatalog {
    static let monitoringActions: [OptimizationAction] = [
        ...
        OptimizationAction(id: "system_check_cpu", titleKey: "action.system_check_cpu.title", descriptionKey: "action.system_check_cpu.description", category: .monitoring, symbolName: "cpu", statusFeatureID: nil, isRisky: false, estimatedTime: "5 seconds", requiresRestart: false, restoreBehavior: .notRestorableInspection(reasonKey: "restore.reason.inspection"), kind: .command([
